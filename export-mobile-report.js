// export-mobile-report.js - Mobile Usability Report Generator
...
const ExportMobileReport = {
  ...
  formatIssueDescription: function (issue) {
    const typeLabels = {
      ...
      'touch-target-too-small': `Touch target too small: ${issue.details?.actual} (${issue.details?.recommended || 'requires ≥48x48px'})`,
  ...
  <div class="container">
    ...
    <div id="no-issues" style="background: #d4edda; border: 2px solid #28a745; border-radius: 8px; padding: 30px; margin: 30px 0; text-align: center;">
      ...
      <p style="color: #155724; font-size: 1.1rem; margin: 0 0 20px 0;">
        All ${pagesAnalyzed.length} analyzed page${pagesAnalyzed.length === 1 ? '' : 's'} passed mobile usability checks using Google Lighthouse standards.
      </p>
...
window.ExportMobileReport = ExportMobileReport;
