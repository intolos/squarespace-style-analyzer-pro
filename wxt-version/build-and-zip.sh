...
rm -rf .output/sqs
rm -f "$OUTPUT_DIR/squarespace-$VERSION-chrome.zip"
...
rm -f "$OUTPUT_DIR/website-$VERSION-chrome.zip"
...
rm -rf .output/wp
rm -f "$OUTPUT_DIR/wp-$VERSION-chrome.zip"
...
rm -rf .output/sqs
rm -f "$OUTPUT_DIR/squarespace-$VERSION-firefox.zip"
...
rm -rf .output/generic
rm -f "$OUTPUT_DIR/website-$VERSION-firefox.zip"
...
rm -rf .output/wp
rm -f "$OUTPUT_DIR/wp-$VERSION-firefox.zip"
