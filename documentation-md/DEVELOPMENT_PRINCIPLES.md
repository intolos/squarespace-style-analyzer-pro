...
> **⚠️ CRITICAL: Before implementing any feature or fix, you MUST read [DEVELOPMENT_PRINCIPLES_CRITICAL.md](./DEVELOPMENT_PRINCIPLES_CRITICAL.md) for accuracy standards and pre-implementation checklists.**
...
> **📋 MOVED: This section has been moved to [DEVELOPMENT_PRINCIPLES_CRITICAL.md](./DEVELOPMENT_PRINCIPLES_CRITICAL.md) for mandatory reading before any feature or fix.**
...
> **📋 MOVED: The full checklist has been moved to [DEVELOPMENT_PRINCIPLES_CRITICAL.md](./DEVELOPMENT_PRINCIPLES_CRITICAL.md) for mandatory reading before any feature or fix.**
